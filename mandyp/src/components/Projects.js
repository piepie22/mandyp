    ...
    <section id="projects">
      ...
      <div className="project-section">
        ...
        <div className="project-item right">
          ...
          <img src="/images/bubbly.jpg" alt="Bubbly Barrel" className="project-image" />
        </div>

        <div className="project-item left">
          <img src="/images/oneup.jpg" alt="1-UP Factory" className="project-image" />
          <div className="project-text">
            <h4>Universal Orlando Resort</h4>
        ...
        <div className="project-item right">
          ...
          <img src="/images/fly.jpg" alt="Funky's Fly-n-Buy" className="project-image" />
        </div>

        <div className="project-item left">
          <img src="/images/cinema.jpg" alt="Universal Cinema" className="project-image" />
          <div className="project-text">
